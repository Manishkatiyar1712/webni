...
<div class="control-group">
<label class="control-label" for="basicinput">Exchange book</label>
<div class="controls">
<input type="text"    name="productBook"  placeholder="Enter book needed" class="span8 tip" required>
</div>
</div>
